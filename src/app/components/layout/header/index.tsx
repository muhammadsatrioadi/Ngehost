        ...
        <div className="container flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link
              ...
              className="hidden lg:block bg-linear-to-r from-primary to-secondary hover:from-secondary hover:to-primary text-white duration-300 px-6 py-3 rounded-lg font-semibold"
            >
              Lihat Paket
            </Link>
            {isSignInOpen && (
            ...
            <Link
              ...
              target="_blank"
              className="hidden lg:block text-white bg-linear-to-r from-secondary to-primary hover:from-primary hover:to-secondary duration-300 px-6 py-3 rounded-lg font-semibold"
            >
              Mulai Sekarang
            </Link>
            {isSignUpOpen && (
